...
public class FormController {
  ...
  @PostMapping
  public ResponseEntity<ApiSingleResponse<FormDTO>> createForm(
      @RequestBody ApiSingleRequest<FormDTO> request) {
  ...
  @PutMapping("{formId}")
  public ResponseEntity<ApiSingleResponse<FormDTO>> updateForm(
      @PathVariable String formId, @RequestBody ApiSingleRequest<FormDTO> request) {
